  ...
  return (
    ...
    >
                ...
                {(() => {
                  ...
                  return [
                    ...
                    <div key={key} className="flex items-center gap-2">
                      <span className={`inline-flex items-center justify-center w-5 h-5 rounded-full text-xs font-medium text-white ${
      ...
      <div className="space-y-3">
        <Label className="text-[#1A1A1A] text-lg">Number of Runs (1-100)</Label>
        <Input
          type="number"
          min="1"
          max="100"
          value={numberOfRuns}
          onChange={(e) =>
            onNumberOfRunsChange(Math.max(1, Math.min(100, Number.parseInt(e.target.value) || 1)))
          }
